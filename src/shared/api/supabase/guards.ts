...
export function requireVersion(version: number | undefined, entity: string): number {
...
export function requireRoomPostComment(snapshot: AppSnapshot, id: string): RoomPostComment {
